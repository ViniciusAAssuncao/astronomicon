...
pub fn solvent_properties_of(formula: &str) -> Option<SolventProperties> {
    match formula {
        ...
        "H2SO4" => Some(SolventProperties::new(
            56000.0,
            10710.0,
            6.12,
            Temperature::new(283.46),
            Pressure::new(1.0),
            Temperature::new(924.0),
            Pressure::new(4.58e6),
            Temperature::new(610.0),
            Temperature::new(283.46),
            Density::new(1830.0),
            Density::new(2130.0),
            0.36,
        ...
        "C2H6" => Some(SolventProperties::new(
            14690.0,
            2860.0,
            2.50,
            Temperature::new(90.40),
            Pressure::new(11.3),
            Temperature::new(305.30),
            Pressure::new(4.87e6),
            Temperature::new(184.60),
            Temperature::new(90.40),
            Density::new(544.0),
            Density::new(717.0),
            0.25,
